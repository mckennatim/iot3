...
* else if finds the prior relay is off and the current relay shows prionoff == 1the sr is off and the prior sr was on. ie srs[priosr].onoff=off and srs[sr].prionoff was on 
